...
static InstructionDefinition lui_rd_imm(
    ISA32_RISCV, "lui", (uint32_t)0x37, (uint32_t)0x7f,
...
static InstructionDefinition auipc_rd_imm(
    ISA32_RISCV, "auipc", (uint32_t)0x17, (uint32_t)0x7f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rd = 0;
        static BitArrayRange R_rd_0(11, 7);
...
static InstructionDefinition jalr_rd_rs1_imm(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//jalr\n") +
                          ...
                          "printf(\"imm_extended = %#x\\n\",imm_extended); \n"
#endif
                          "etiss_int32 cast_0 = *((RISCV*)cpu)->X[" +
                          toString(rs1) +
                          "]; \n"
                          "if((etiss_int32)((etiss_uint32)cast_0 - 0x80000000) > 0x0)\n"
                          "{\n"
...
#endif
                          "if(*((RISCV*)cpu)->X[" +
                          toString(rs1) + "] == *((RISCV*)cpu)->X[" + toString(rs2) +
                          "])\n"
                          "{\n"
                          "etiss_int32 cast_0 = " +
                          toString((uint32_t)ic.current_address_) +
...
static InstructionDefinition fence_i_(
    ISA32_RISCV, "fence_i", (uint32_t)0x100f, (uint32_t)0x707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition csrrw_rd_csr_rs1(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//csrrw\n") +
                          ...
                          "((RISCV*)cpu)->CSR[uAddr] = ((((RISCV*)cpu)->CSR[uAddr] & ~writeMask) | (rs_val & "
...
static InstructionDefinition blt_rs1_rs2_imm(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//blt\n") +
                          ...
                          "cast_0 =0x0 + (etiss_uint32)cast_0 ;\n"
                          "}\n"
                          "etiss_int32 cast_1 = *((RISCV*)cpu)->X[" +
                          toString(rs1) +
                          "]; \n"
...
static InstructionDefinition csrrwi_rd_csr_zimm(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//csrrwi\n") +
                          ...
                          "{\n"
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = ((RISCV*)cpu)->CSR[" + toString(csr) +
                          "];\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
                          ...
                          "((RISCV*)cpu)->CSR[uAddr] = ((((RISCV*)cpu)->CSR[uAddr] & ~writeMask) | ((etiss_uint32)" +
                          toString(zimm) +
                          " & writeMask))&0xffffffff;\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->CSR[uAddr] = %#x\\n\",((RISCV*)cpu)->CSR[uAddr]); \n"
                          ...
                          "{\n"
                          "((RISCV*)cpu)->CSR[" +
                          toString(csr) + "] = (etiss_uint32)" + toString(zimm) +
                          ";\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->CSR[" +
                          toString(csr) + "] = %#x\\n\",((RISCV*)cpu)->CSR[" + toString(csr) +
...
static InstructionDefinition ori_rd_rs1_imm(
    ISA32_RISCV, "ori", (uint32_t)0x6013, (uint32_t)0x707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition csrrsi_rd_csr_zimm(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() =
            ...
            "((RISCV*)cpu)->CSR[uAddr] = ((((RISCV*)cpu)->CSR[uAddr] & ~writeMask) | ((res | (etiss_uint32)" +
            toString(zimm) +
            ") & writeMask))&0xffffffff;\n"
#if RISCV_DEBUG_CALL
            "printf(\"((RISCV*)cpu)->CSR[uAddr] = %#x\\n\",((RISCV*)cpu)->CSR[uAddr]); \n"
            ...
            "{\n"
            "((RISCV*)cpu)->CSR[" +
            toString(csr) + "] = (res | (etiss_uint32)" + toString(zimm) +
            ");\n"
#if RISCV_DEBUG_CALL
            "printf(\"((RISCV*)cpu)->CSR[" +
            toString(csr) + "] = %#x\\n\",((RISCV*)cpu)->CSR[" + toString(csr) +
...
static InstructionDefinition csrrci_rd_csr_zimm(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() =
            ...
            "((RISCV*)cpu)->CSR[uAddr] = ((((RISCV*)cpu)->CSR[uAddr] & ~writeMask) | ((res & ~(etiss_uint32)" +
            toString(zimm) +
            ") & writeMask))&0xffffffff&0xffffffff;\n"
#if RISCV_DEBUG_CALL
            "printf(\"((RISCV*)cpu)->CSR[uAddr] = %#x\\n\",((RISCV*)cpu)->CSR[uAddr]); \n"
#endif
            "((RISCV*)cpu)->CSR[sAddr] = ((RISCV*)cpu)->CSR[uAddr];\n"
...
static InstructionDefinition csrrs_rd_csr_rs1(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//csrrs\n") +
                          ...
                          "((RISCV*)cpu)->CSR[uAddr] = ((((RISCV*)cpu)->CSR[uAddr] & ~writeMask) | ((xrd | xrs1) & "
                          "writeMask))&0xffffffff;\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->CSR[uAddr] = %#x\\n\",((RISCV*)cpu)->CSR[uAddr]); \n"
#endif
...
static InstructionDefinition flw_rd_imm_xrs1_(
    ISA32_RISCV, "flw", (uint32_t)0x2007, (uint32_t)0x707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition fsw_rs2_imm_xrs1_(
    ISA32_RISCV, "fsw", (uint32_t)0x2027, (uint32_t)0x707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition sltiu_rd_rs1_imm(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//sltiu\n") +
                          ...
                          " != 0)\n"
                          "{\n"
                          "if((etiss_uint32)*((RISCV*)cpu)->X[" +
                          toString(rs1) +
                          "] < (etiss_uint32)full_imm)\n"
                          "{\n"
                          "choose1 = 1;\n"
#if RISCV_DEBUG_CALL
                          "printf(\"choose1 = %#x\\n\",choose1); \n"
...
static InstructionDefinition fld_rd_imm_rs1_(
    ISA32_RISCV, "fld", (uint32_t)0x3007, (uint32_t)0x707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition fsd_rs2_imm_rs1_(
    ISA32_RISCV, "fsd", (uint32_t)0x3027, (uint32_t)0x707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fmadd_s_rd_frs1_frs2_frs3(
    ISA32_RISCV, "fmadd.s", (uint32_t)0x43, (uint32_t)0x600007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//fmadd.s\n") +
                          ...
                          "}\n"
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = fmadd_s(((RISCV*)cpu)->F[" + toString(rs1) + "], ((RISCV*)cpu)->F[" +
                          toString(rs2) + "], ((RISCV*)cpu)->F[" + toString(rs3) +
                          ...
                          "else\n"
                          "{\n"
                          "frs1 = unbox_s(((RISCV*)cpu)->F[" +
                          toString(rs1) +
                          "]);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"frs1 = %#x\\n\",frs1); \n"
#endif
                          "frs2 = unbox_s(((RISCV*)cpu)->F[" +
                          toString(rs2) +
                          "]);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"frs2 = %#x\\n\",frs2); \n"
#endif
                          "frs3 = unbox_s(((RISCV*)cpu)->F[" +
                          toString(rs3) +
                          "]);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"frs3 = %#x\\n\",frs3); \n"
...
static InstructionDefinition fmsub_s_rd_frs1_frs2_frs3(
    ISA32_RISCV, "fmsub.s", (uint32_t)0x47, (uint32_t)0x600007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fnmadd_s_rd_frs1_frs2_frs3(
    ISA32_RISCV, "fnmadd.s", (uint32_t)0x4f, (uint32_t)0x600007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fnmsub_s_rd_frs1_frs2_frs3(
    ISA32_RISCV, "fnmsub.s", (uint32_t)0x4b, (uint32_t)0x600007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fmadd_d_rd_frs1_frs2_frs3(
    ISA32_RISCV, "fmadd.d", (uint32_t)0x2000043, (uint32_t)0x600007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
#endif
                          "}\n"
                          "res = fmadd_d((((RISCV*)cpu)->F[" +
                          toString(rs1) + "] & 0xffffffffffffffff), (((RISCV*)cpu)->F[" + toString(rs2) +
                          "] & 0xffffffffffffffff), (((RISCV*)cpu)->F[" + toString(rs3) +
...
static InstructionDefinition fmsub_d_rd_frs1_frs2_frs3(
    ISA32_RISCV, "fmsub.d", (uint32_t)0x2000047, (uint32_t)0x600007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fnmadd_d_rd_frs1_frs2_frs3(
    ISA32_RISCV, "fnmadd.d", (uint32_t)0x200004f, (uint32_t)0x600007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fnmsub_d_rd_frs1_frs2_frs3(
    ISA32_RISCV, "fnmsub.d", (uint32_t)0x200004b, (uint32_t)0x600007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition slli_rd_rs1_shamt(
    ISA32_RISCV, "slli", (uint32_t)0x1013, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
        ...
        partInit.code() = std::string("//slli\n") +
                          ...
                          "{\n"
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = (*((RISCV*)cpu)->X[" + toString(rs1) + "] << " + toString(shamt) +
                          ");\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
...
static InstructionDefinition sll_rd_rs1_rs2(
    ISA32_RISCV, "sll", (uint32_t)0x1033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//sll\n") +
                          ...
                          "{\n"
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = (*((RISCV*)cpu)->X[" + toString(rs1) + "] << (*((RISCV*)cpu)->X[" +
                          toString(rs2) +
                          "] & 32 - 1));\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
...
static InstructionDefinition srli_rd_rs1_shamt(
    ISA32_RISCV, "srli", (uint32_t)0x5013, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition srl_rd_rs1_rs2(
    ISA32_RISCV, "srl", (uint32_t)0x5033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition add_rd_rs1_rs2(
    ISA32_RISCV, "add", (uint32_t)0x33, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition slt_rd_rs1_rs2(
    ISA32_RISCV, "slt", (uint32_t)0x2033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition sltu_rd_rs1_rs2(
    ISA32_RISCV, "sltu", (uint32_t)0x3033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//sltu\n") +
                          ...
                          "{\n"
                          "if((etiss_uint32)*((RISCV*)cpu)->X[" +
                          toString(rs1) + "] < (etiss_uint32)*((RISCV*)cpu)->X[" + toString(rs2) +
                          "])\n"
                          "{\n"
                          "choose1 = 1;\n"
#if RISCV_DEBUG_CALL
...
static InstructionDefinition xor_rd_rs1_rs2(
    ISA32_RISCV, "xor", (uint32_t)0x4033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition or_rd_rs1_rs2(
    ISA32_RISCV, "or", (uint32_t)0x6033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition and_rd_rs1_rs2(
    ISA32_RISCV, "and", (uint32_t)0x7033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition uret_(
    ISA32_RISCV, "uret", (uint32_t)0x200073, (uint32_t)0xffffffff,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        CodePart &partInit = cs.append(CodePart::INITIALREQUIRED);
        partInit.getAffectedRegisters().add("instructionPointer", 32);
        partInit.code() = std::string("//uret\n") +
                          ...
                          "((RISCV*)cpu)->CSR[0] ^= ((etiss_uint32)((((RISCV*)cpu)->CSR[0] & 0x10)>>4)) ^ "
                          "(((RISCV*)cpu)->CSR[0] & 0x1);\n"                    // UIE=UPIE
...
static InstructionDefinition fadd_s_rd_frs1_frs2(
    ISA32_RISCV, "fadd.s", (uint32_t)0x53, (uint32_t)0xfe00007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//fadd.s\n") +
                          ...
                          "}\n"
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = fadd_s(((RISCV*)cpu)->F[" + toString(rs1) + "], ((RISCV*)cpu)->F[" +
                          toString(rs2) +
                          "], choose1);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->F[" +
...
static InstructionDefinition srai_rd_rs1_shamt(
    ISA32_RISCV, "srai", (uint32_t)0x40005013, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
        ...
        partInit.code() = std::string("//srai\n") +
                          ...
                          "}\n"
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = ((etiss_int32)cast_0 >> " + toString(shamt) +
                          ");\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
...
static InstructionDefinition sra_rd_rs1_rs2(
    ISA32_RISCV, "sra", (uint32_t)0x40005033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//sra\n") +
                          ...
                          "}\n"
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = ((etiss_int32)cast_0 >> (*((RISCV*)cpu)->X[" + toString(rs2) +
                          "] & 32 - 1));\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
...
static InstructionDefinition sub_rd_rs1_rs2(
    ISA32_RISCV, "sub", (uint32_t)0x40000033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fcvt_s_d_rd_frs1(
    ISA32_RISCV, "fcvt.s.d", (uint32_t)0x40100053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition fence_(
    ISA32_RISCV, "fence", (uint32_t)0xf, (uint32_t)0xf000707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition ecall_(
    ISA32_RISCV, "ecall", (uint32_t)0x73, (uint32_t)0xffffffff,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        CodePart &partInit = cs.append(CodePart::INITIALREQUIRED);
        partInit.getAffectedRegisters().add("instructionPointer", 32);
...
static InstructionDefinition ebreak_(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() += "*((RISCV*)cpu)->X[" + std::to_string(10U) +
                           "] = etiss_semihost(cpu, system, plugin_pointers, " + std::to_string(32) +
                           ", operation, parameter);\n";
        partInit.code() += "}\n";
        partInit.code() += " else {\n";
...
static InstructionDefinition sret_(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//sret\n") +
                          ...
                          "((RISCV*)cpu)->CSR[256] ^= ((etiss_uint32)((((RISCV*)cpu)->CSR[256] & 0x20)>>4)) ^ "
                          "(((RISCV*)cpu)->CSR[256] & 0x2);\n"                   // SIE=SPIE
...
static InstructionDefinition wfi_(
    ISA32_RISCV, "wfi", (uint32_t)0x10500073, (uint32_t)0xffffffff,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        CodePart &partInit = cs.append(CodePart::INITIALREQUIRED);
        partInit.getAffectedRegisters().add("instructionPointer", 32);
...
static InstructionDefinition fmul_s_rd_frs1_frs2(
    ISA32_RISCV, "fmul.s", (uint32_t)0x10000053, (uint32_t)0xfe00007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//fmul.s\n") +
                          ...
                          "}\n"
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = fmul_s(((RISCV*)cpu)->F[" + toString(rs1) + "], ((RISCV*)cpu)->F[" +
                          toString(rs2) +
                          "], choose1);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->F[" +
...
static InstructionDefinition mret_(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//mret\n") +
                          ...
                          "((RISCV*)cpu)->CSR[768] ^= ((etiss_uint32)((((RISCV*)cpu)->CSR[768] & 0x80)>>4)) ^ "
                          "(((RISCV*)cpu)->CSR[768] & 0x8);\n"                   // MIE=MPIE
...
static InstructionDefinition sfence_vma_(
    ISA32_RISCV, "sfence.vma", (uint32_t)0x12000073, (uint32_t)0xfe007fff,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fmul_d_rd_frs1_frs2(
    ISA32_RISCV, "fmul.d", (uint32_t)0x12000053, (uint32_t)0xfe00007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition mul_rd_rs1_rs2(
    ISA32_RISCV, "mul", (uint32_t)0x2000033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//mul\n") +
                          ...
                          " != 0)\n"
                          "{\n"
                          "res = ((etiss_uint64)*((RISCV*)cpu)->X[" +
                          toString(rs1) + "] * (etiss_uint64)*((RISCV*)cpu)->X[" + toString(rs2) +
                          "]);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"res = %#lx\\n\",res); \n"
#endif
...
static InstructionDefinition mulh_rd_rs1_rs2(
    ISA32_RISCV, "mulh", (uint32_t)0x2001033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition mulhsu_rd_rs1_rs2(
    ISA32_RISCV, "mulhsu", (uint32_t)0x2002033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//mulhsu\n") +
                          ...
                          "cast_0 =0x0 + (etiss_uint32)cast_0 ;\n"
                          "}\n"
                          "res = ((etiss_int64)cast_0 * (etiss_uint64)*((RISCV*)cpu)->X[" +
                          toString(rs2) +
                          "]);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"res = %#lx\\n\",res); \n"
...
static InstructionDefinition mulhu_rd_rs1_rs2(
    ISA32_RISCV, "mulhu", (uint32_t)0x2003033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition div_rd_rs1_rs2(
    ISA32_RISCV, "div", (uint32_t)0x2004033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//div\n") +
...
#endif
                          "if((*((RISCV*)cpu)->X[" +
                          toString(rs1) + "] == MMIN) && (*((RISCV*)cpu)->X[" + toString(rs2) +
                          "] == M1))\n"
                          "{\n"
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) +
                          "] = ((etiss_int32)cast_1 / (etiss_int32)cast_0);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
                          "]); \n"
...
static InstructionDefinition divu_rd_rs1_rs2(
    ISA32_RISCV, "divu", (uint32_t)0x2005033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition rem_rd_rs1_rs2(
    ISA32_RISCV, "rem", (uint32_t)0x2006033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//rem\n") +
                          ...
                          "{\n"
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = *((RISCV*)cpu)->X[" + toString(rs1) +
                          "];\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
...
static InstructionDefinition remu_rd_rs1_rs2(
    ISA32_RISCV, "remu", (uint32_t)0x2007033, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fadd_d_rd_frs1_frs2(
    ISA32_RISCV, "fadd.d", (uint32_t)0x2000053, (uint32_t)0xfe00007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fsub_s_rd_frs1_frs2(
    ISA32_RISCV, "fsub.s", (uint32_t)0x8000053, (uint32_t)0xfe00007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//fsub.s\n") +
                          ...
                          "}\n"
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = fsub_s(((RISCV*)cpu)->F[" + toString(rs1) + "], ((RISCV*)cpu)->F[" +
                          toString(rs2) +
                          "], choose1);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->F[" +
...
static InstructionDefinition fdiv_s_rd_frs1_frs2(
    ISA32_RISCV, "fdiv.s", (uint32_t)0x18000053, (uint32_t)0xfe00007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//fdiv.s\n") +
                          ...
                          "}\n"
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = fdiv_s(((RISCV*)cpu)->F[" + toString(rs1) + "], ((RISCV*)cpu)->F[" +
                          toString(rs2) +
                          "], choose1);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->F[" +
...
static InstructionDefinition fsqrt_s_rd_frs1(
    ISA32_RISCV, "fsqrt.s", (uint32_t)0x58000053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
        ...
        partInit.code() = std::string("//fsqrt.s\n") +
                          ...
                          "}\n"
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = fsqrt_s(((RISCV*)cpu)->F[" + toString(rs1) +
                          "], choose1);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->F[" +
                          toString(rd) + "] = %#lx\\n\",((RISCV*)cpu)->F[" + toString(rd) +
...
static InstructionDefinition fsgnj_s_rd_frs1_frs2(
    ISA32_RISCV, "fsgnj.s", (uint32_t)0x20000053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//fsgnj.s\n") +
                          ...
                          "{\n"
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = ((((RISCV*)cpu)->F[" + toString(rs1) +
                          "] & 2147483647) | (((RISCV*)cpu)->F[" + toString(rs2) +
                          "] & -2147483648));\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->F[" +
                          toString(rd) + "] = %#lx\\n\",((RISCV*)cpu)->F[" + toString(rd) +
...
static InstructionDefinition fsgnjn_s_rd_frs1_frs2(
    ISA32_RISCV, "fsgnjn.s", (uint32_t)0x20001053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fsgnjx_s_rd_frs1_frs2(
    ISA32_RISCV, "fsgnjx.s", (uint32_t)0x20002053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//fsgnjx.s\n") +
                          ...
                          "{\n"
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = (((RISCV*)cpu)->F[" + toString(rs1) + "] ^ (((RISCV*)cpu)->F[" +
                          toString(rs2) +
                          "] & -2147483648));\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->F[" +
...
static InstructionDefinition fmin_s_rd_frs1_frs2(
    ISA32_RISCV, "fmin.s", (uint32_t)0x28000053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//fmin.s\n") +
                          ...
                          "{\n"
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = fsel_s(((RISCV*)cpu)->F[" + toString(rs1) + "], ((RISCV*)cpu)->F[" +
                          toString(rs2) +
                          "], (etiss_uint32)0);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->F[" +
...
static InstructionDefinition fmax_s_rd_frs1_frs2(
    ISA32_RISCV, "fmax.s", (uint32_t)0x28001053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fcvt_w_s_rd_frs1(
    ISA32_RISCV, "fcvt.w.s", (uint32_t)0xc0000053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
        ...
        partInit.code() = std::string("//fcvt.w.s\n") +
                          ...
                          "if(64 == 32)\n"
                          "{\n"
                          "etiss_int32 cast_0 = fcvt_s(((RISCV*)cpu)->F[" +
...
static InstructionDefinition fcvt_wu_s_rd_frs1(
    ISA32_RISCV, "fcvt.wu.s", (uint32_t)0xc0100053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition feq_s_rd_frs1_frs2(
    ISA32_RISCV, "feq.s", (uint32_t)0xa0002053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//feq.s\n") +
                          ...
                          "{\n"
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = (etiss_uint32)fcmp_s(((RISCV*)cpu)->F[" + toString(rs1) +
                          "], ((RISCV*)cpu)->F[" + toString(rs2) +
                          "], (etiss_uint32)0);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) +
                          "] = (etiss_uint32)fcmp_s(frs1, frs2, (etiss_uint32)0);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
                          "]); \n"
...
static InstructionDefinition flt_s_rd_frs1_frs2(
    ISA32_RISCV, "flt.s", (uint32_t)0xa0001053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//flt.s\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) +
                          "] = (etiss_uint32)fcmp_s(frs1, frs2, (etiss_uint32)2);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
                          "]); \n"
                          ...
                          "}\n"
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = fcmp_s((((RISCV*)cpu)->F[" + toString(rs1) +
                          "] & 0xffffffff), (((RISCV*)cpu)->F[" + toString(rs2) +
...
static InstructionDefinition fle_s_rd_frs1_frs2(
    ISA32_RISCV, "fle.s", (uint32_t)0xa0000053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//fle.s\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) +
                          "] = (etiss_uint32)fcmp_s(frs1, frs2, (etiss_uint32)1);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
                          "]); \n"
...
static InstructionDefinition fclass_s_rd_frs1(
    ISA32_RISCV, "fclass.s", (uint32_t)0xe0001053, (uint32_t)0xfff0707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
        ...
        partInit.code() = std::string("//fclass.s\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = fclass_s(unbox_s(((RISCV*)cpu)->F[" + toString(rs1) +
                          "]));\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
...
static InstructionDefinition fmv_x_w_rd_frs1(
    ISA32_RISCV, "fmv.x.w", (uint32_t)0xe0000053, (uint32_t)0xfff0707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
        ...
        partInit.code() = std::string("//fmv.x.w\n") +
                          ...
                          "etiss_int64 cast_0 = (((RISCV*)cpu)->F[" +
                          toString(rs1) +
                          "] & 0xffffffff); \n"
...
static InstructionDefinition fcvt_s_w_rd_rs1(
    ISA32_RISCV, "fcvt.s.w", (uint32_t)0xd0000053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
        ...
        partInit.code() = std::string("//fcvt.s.w\n") +
                          ...
                          "{\n"
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = fcvt_s((*((RISCV*)cpu)->X[" + toString(rs1) +
...
static InstructionDefinition fcvt_s_wu_rd_rs1(
    ISA32_RISCV, "fcvt.s.wu", (uint32_t)0xd0100053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition fmv_w_x_rd_rs1(
    ISA32_RISCV, "fmv.w.x", (uint32_t)0xf0000053, (uint32_t)0xfff0707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
#endif
                          "((RISCV*)cpu)->F[" +
                          toString(rd) + "] = ((upper << 32) | (etiss_uint64)(*((RISCV*)cpu)->X[" + toString(rs1) +
                          "] & 0xffffffff));\n"
#if RISCV_DEBUG_CALL
                          "printf(\"((RISCV*)cpu)->F[" +
                          toString(rd) + "] = %#lx\\n\",((RISCV*)cpu)->F[" + toString(rd) +
...
static InstructionDefinition fsub_d_rd_frs1_frs2(
    ISA32_RISCV, "fsub.d", (uint32_t)0xa000053, (uint32_t)0xfe00007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fdiv_d_rd_frs1_frs2(
    ISA32_RISCV, "fdiv.d", (uint32_t)0x1a000053, (uint32_t)0xfe00007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fsqrt_d_rd_frs1(
    ISA32_RISCV, "fsqrt.d", (uint32_t)0x5a000053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition fsgnj_d_rd_frs1_frs2(
    ISA32_RISCV, "fsgnj.d", (uint32_t)0x22000053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
#endif
                          "res = (((((RISCV*)cpu)->F[" +
                          toString(rs1) + "] & 0xffffffffffffffff) & MSK2) | ((((RISCV*)cpu)->F[" + toString(rs2) +
...
static InstructionDefinition fsgnjn_d_rd_frs1_frs2(
    ISA32_RISCV, "fsgnjn.d", (uint32_t)0x22001053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fsgnjx_d_rd_frs1_frs2(
    ISA32_RISCV, "fsgnjx.d", (uint32_t)0x22002053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fmin_d_rd_frs1_frs2(
    ISA32_RISCV, "fmin.d", (uint32_t)0x2a000053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fmax_d_rd_frs1_frs2(
    ISA32_RISCV, "fmax.d", (uint32_t)0x2a001053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fcvt_d_s_rd_frs1(
    ISA32_RISCV, "fcvt.d.s", (uint32_t)0x42000053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition feq_d_rd_frs1_frs2(
    ISA32_RISCV, "feq.d", (uint32_t)0xa2002053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//feq.d\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = (etiss_uint32)fcmp_d((((RISCV*)cpu)->F[" + toString(rs1) +
                          "] & 0xffffffffffffffff), (((RISCV*)cpu)->F[" + toString(rs2) +
                          "] & 0xffffffffffffffff), (etiss_uint32)0);\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
...
static InstructionDefinition flt_d_rd_frs1_frs2(
    ISA32_RISCV, "flt.d", (uint32_t)0xa2001053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fle_d_rd_frs1_frs2(
    ISA32_RISCV, "fle.d", (uint32_t)0xa2000053, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition fclass_d_rd_frs1(
    ISA32_RISCV, "fclass.d", (uint32_t)0xe2001053, (uint32_t)0xfff0707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
        ...
        partInit.code() = std::string("//fclass.d\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = fclass_d((((RISCV*)cpu)->F[" + toString(rs1) +
                          "] & 0xffffffffffffffff));\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
...
static InstructionDefinition fcvt_w_d_rd_frs1(
    ISA32_RISCV, "fcvt.w.d", (uint32_t)0xc2000053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
        ...
        partInit.code() = std::string("//fcvt.w.d\n") +
                          ...
                          "etiss_int32 cast_0 = fcvt_64_32((((RISCV*)cpu)->F[" +
...
static InstructionDefinition fcvt_wu_d_rd_frs1(
    ISA32_RISCV, "fcvt.wu.d", (uint32_t)0xc2100053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition fcvt_d_w_rd_rs1(
    ISA32_RISCV, "fcvt.d.w", (uint32_t)0xd2000053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
...
static InstructionDefinition fcvt_d_wu_rd_rs1(
    ISA32_RISCV, "fcvt.d.wu", (uint32_t)0xd2100053, (uint32_t)0xfff0007f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(19, 15);
        ...
        partInit.code() = std::string("//fcvt.d.wu\n") +
                          ...
                          "res = fcvt_32_64((etiss_uint64)(*((RISCV*)cpu)->X[" +
                          toString(rs1) + "] & 0xffffffff), (etiss_uint32)3, (" + toString(rm) +
                          " & 0xff));\n"
#if RISCV_DEBUG_CALL
                          "printf(\"res = %#lx\\n\",res); \n"
...
static InstructionDefinition c_addi4spn_rd_imm(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//c.addi4spn\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + " + 8] = *((RISCV*)cpu)->X[2] + " + toString(imm) +
                          ";\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + " + 8] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
...
static InstructionDefinition c_addi_rs1_imm(
    ISA16_RISCV, "c.addi", (uint16_t)0x1, (uint16_t)0xe003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
...
static InstructionDefinition c_nop_(
    ISA16_RISCV, "c.nop", (uint16_t)0x1, (uint16_t)0xffff,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        CodePart &partInit = cs.append(CodePart::INITIALREQUIRED);
        partInit.getAffectedRegisters().add("instructionPointer", 32);
...
static InstructionDefinition dii_(
    ISA16_RISCV, "dii", (uint16_t)0x0, (uint16_t)0xffff,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        CodePart &partInit = cs.append(CodePart::INITIALREQUIRED);
        partInit.getAffectedRegisters().add("instructionPointer", 32);
...
static InstructionDefinition c_slli_rs1_shamt(
    ISA16_RISCV, "c.slli", (uint16_t)0x2, (uint16_t)0xf003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(11, 7);
        ...
        partInit.code() = std::string("//c.slli\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rs1) + "] = (*((RISCV*)cpu)->X[" + toString(rs1) + "] << " + toString(shamt) +
                          ");\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rs1) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rs1) +
...
static InstructionDefinition c_li_rd_imm(
    ISA16_RISCV, "c.li", (uint16_t)0x4001, (uint16_t)0xe003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rd = 0;
        static BitArrayRange R_rd_0(11, 7);
...
static InstructionDefinition c_fld_rd_uimm_8_rs1_(
    ISA16_RISCV, "c.fld", (uint16_t)0x2000, (uint16_t)0xe003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(9, 7);
...
static InstructionDefinition c_fldsp_rd_uimm_x2_(
    ISA16_RISCV, "c.fldsp", (uint16_t)0x2002, (uint16_t)0xe003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 uimm = 0;
        static BitArrayRange R_uimm_5(12, 12);
...
static InstructionDefinition c_addi16sp_imm(
    ISA16_RISCV, "c.addi16sp", (uint16_t)0x6101, (uint16_t)0xef83,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_int32 imm = 0;
...
static InstructionDefinition c_flw_rd_uimm_8_rs1_(
    ISA16_RISCV, "c.flw", (uint16_t)0x6000, (uint16_t)0xe003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(9, 7);
...
static InstructionDefinition c_flwsp_rd_uimm_x2_(
    ISA16_RISCV, "c.flwsp", (uint16_t)0x6002, (uint16_t)0xe003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 uimm = 0;
        static BitArrayRange R_uimm_5(12, 12);
...
static InstructionDefinition c_srli_8_rs1_shamt(
    ISA16_RISCV, "c.srli", (uint16_t)0x8001, (uint16_t)0xfc03,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(9, 7);
        ...
        partInit.code() = std::string("//c.srli\n") +
                          ...
                          "printf(\"rs1_idx = %#x\\n\",rs1_idx); \n"
#endif
                          "*((RISCV*)cpu)->X[rs1_idx] = (*((RISCV*)cpu)->X[rs1_idx] >> " +
                          toString(shamt) +
                          ");\n"
#if RISCV_DEBUG_CALL
...
static InstructionDefinition c_srai_8_rs1_shamt(
    ISA16_RISCV, "c.srai", (uint16_t)0x8401, (uint16_t)0xfc03,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(9, 7);
        ...
        partInit.code() = std::string("//c.srai\n") +
                          ...
                          "cast_0 =0x0 + (etiss_uint32)cast_0 ;\n"
                          "}\n"
                          "*((RISCV*)cpu)->X[rs1_idx] = ((etiss_int32)cast_0 >> " +
                          toString(shamt) +
                          ");\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[rs1_idx] = %#x\\n\",*((RISCV*)cpu)->X[rs1_idx]); \n"
...
static InstructionDefinition c_sub_8_rd_8_rs2(
    ISA16_RISCV, "c.sub", (uint16_t)0x8c01, (uint16_t)0xfc63,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(4, 2);
        ...
        partInit.code() = std::string("//c.sub\n") +
                          ...
                          "printf(\"rd_idx = %#x\\n\",rd_idx); \n"
#endif
                          "*((RISCV*)cpu)->X[rd_idx] = *((RISCV*)cpu)->X[rd_idx] - *((RISCV*)cpu)->X[" +
                          toString(rs2) +
                          " + 8];\n"
#if RISCV_DEBUG_CALL
...
static InstructionDefinition c_xor_8_rd_8_rs2(
    ISA16_RISCV, "c.xor", (uint16_t)0x8c21, (uint16_t)0xfc63,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(4, 2);
...
static InstructionDefinition c_or_8_rd_8_rs2(
    ISA16_RISCV, "c.or", (uint16_t)0x8c41, (uint16_t)0xfc63,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(4, 2);
...
static InstructionDefinition c_and_8_rd_8_rs2(
    ISA16_RISCV, "c.and", (uint16_t)0x8c61, (uint16_t)0xfc63,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(4, 2);
...
static InstructionDefinition c_mv_rd_rs2(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//c.mv\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = *((RISCV*)cpu)->X[" + toString(rs2) +
                          "];\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
...
static InstructionDefinition c_jr_rs1(
    ISA16_RISCV, "c.jr", (uint16_t)0x8002, (uint16_t)0xf07f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(11, 7);
        ...
        partInit.code() = std::string("//c.jr\n") +
                          ...
                          "cpu->instructionPointer = *((RISCV*)cpu)->X[" +
                          toString(rs1) +
                          "];\n"
#if RISCV_DEBUG_CALL
                          "printf(\"cpu->instructionPointer = %#lx\\n\",cpu->instructionPointer); \n"
...
static InstructionDefinition c_andi_8_rs1_imm(
    ISA16_RISCV, "c.andi", (uint16_t)0x8801, (uint16_t)0xec03,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(9, 7);
...
static InstructionDefinition c_add_rd_rs2(
    ...
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        ...
        partInit.code() = std::string("//c.add\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = *((RISCV*)cpu)->X[" + toString(rd) + "] + *((RISCV*)cpu)->X[" +
                          toString(rs2) +
                          "];\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
...
static InstructionDefinition c_jalr_rs1(
    ISA16_RISCV, "c.jalr", (uint16_t)0x9002, (uint16_t)0xf07f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs1 = 0;
        static BitArrayRange R_rs1_0(11, 7);
...
static InstructionDefinition c_ebreak_(
    ISA16_RISCV, "c.ebreak", (uint16_t)0x9002, (uint16_t)0xffff,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        CodePart &partInit = cs.append(CodePart::INITIALREQUIRED);
        partInit.getAffectedRegisters().add("instructionPointer", 32);
...
static InstructionDefinition c_fsd_rs2_uimm_8_rs1_(
    ISA16_RISCV, "c.fsd", (uint16_t)0xa000, (uint16_t)0xe003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(4, 2);
...
static InstructionDefinition c_fsdsp_rs2_uimm_x2_(
    ISA16_RISCV, "c.fsdsp", (uint16_t)0xa002, (uint16_t)0xe003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(6, 2);
...
static InstructionDefinition c_fsw_rs2_uimm_8_rs1_(
    ISA16_RISCV, "c.fsw", (uint16_t)0xe000, (uint16_t)0xe003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(4, 2);
...
static InstructionDefinition c_fswsp_rs2_uimm_x2_(
    ISA16_RISCV, "c.fswsp", (uint16_t)0xe002, (uint16_t)0xe003,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(6, 2);
...
static InstructionDefinition add8_rs2_rs1_rd(
    ISA32_RISCV, "add8", (uint32_t)0x4800007f, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() =
            ...
            "*((RISCV*)cpu)->X[" +
            toString(rd) +
            "] = (((((byte_4 & 255) << 24) | ((byte_3 & 255) << 16)) | ((byte_2 & 255) << 8)) | (byte_1 & 255));\n"
#if RISCV_DEBUG_CALL
            "printf(\"*((RISCV*)cpu)->X[" +
            toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
            "]); \n"
...
static InstructionDefinition sub8_rs2_rs1_rd(
    ISA32_RISCV, "sub8", (uint32_t)0x4a00007f, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition smaqa_rs2_rs1_rd(
    ISA32_RISCV, "smaqa", (uint32_t)0xc800007f, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//smaqa\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) +
                          "] = rd_val + byte_1 + byte_2 + byte_3 + byte_4;\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
                          "]); \n"
...
static InstructionDefinition sll8_rs2_rs1_rd(
    ISA32_RISCV, "sll8", (uint32_t)0x5c00007f, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition smin8_rs2_rs1_rd(
    ISA32_RISCV, "smin8", (uint32_t)0x8800007f, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition smax8_rs2_rs1_rd(
    ISA32_RISCV, "smax8", (uint32_t)0x8a00007f, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
...
static InstructionDefinition smax16_rs2_rs1_rd(
    ISA32_RISCV, "smax16", (uint32_t)0x8200007f, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
        ...
        partInit.code() = std::string("//smax16\n") +
                          ...
                          "*((RISCV*)cpu)->X[" +
                          toString(rd) +
                          "] = (((half_word_2 & 65535) << 16) | (half_word_1 & 65535));\n"
#if RISCV_DEBUG_CALL
                          "printf(\"*((RISCV*)cpu)->X[" +
                          toString(rd) + "] = %#x\\n\",*((RISCV*)cpu)->X[" + toString(rd) +
                          "]); \n"
...
static InstructionDefinition scmple8_rs2_rs1_rd(
    ISA32_RISCV, "scmple8", (uint32_t)0x1e00007f, (uint32_t)0xfe00707f,
    [](BitArray &ba, etiss::CodeSet &cs, InstructionContext &ic)
    {
        etiss_uint32 rs2 = 0;
        static BitArrayRange R_rs2_0(24, 20);
